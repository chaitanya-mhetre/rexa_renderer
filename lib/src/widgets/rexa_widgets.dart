...
class RexaScaffoldWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaScaffoldWidget({super.key, required this.node, required this.registry});

  @override
  Widget build(BuildContext context) {
    final tokens = RexaTheme.of(context);
...
class RexaAppBarWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaAppBarWidget({super.key, required this.node, required this.registry});
...
class RexaTextWidget extends StatelessWidget {
  final RexaNode node;
  const RexaTextWidget({super.key, required this.node});
...
class RexaColumnWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaColumnWidget({super.key, required this.node, required this.registry});
...
class RexaRowWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaRowWidget({super.key, required this.node, required this.registry});
...
class RexaContainerWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaContainerWidget({super.key, required this.node, required this.registry});
...
class RexaPaddingWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaPaddingWidget({super.key, required this.node, required this.registry});
...
class RexaCenterWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaCenterWidget({super.key, required this.node, required this.registry});
...
class RexaExpandedWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaExpandedWidget({super.key, required this.node, required this.registry});
...
class RexaSpacerWidget extends StatelessWidget {
  final RexaNode node;
  const RexaSpacerWidget({super.key, required this.node});
...
class RexaSizedBoxWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaSizedBoxWidget({super.key, required this.node, required this.registry});
...
class RexaImageWidget extends StatelessWidget {
  final RexaNode node;
  const RexaImageWidget({super.key, required this.node});
...
class RexaButtonWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaButtonWidget({super.key, required this.node, required this.registry});
...
class RexaIconWidget extends StatelessWidget {
  final RexaNode node;
  const RexaIconWidget({super.key, required this.node});
...
class RexaDividerWidget extends StatelessWidget {
  final RexaNode node;
  const RexaDividerWidget({super.key, required this.node});
...
class RexaCardWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaCardWidget({super.key, required this.node, required this.registry});
...
class RexaListViewWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaListViewWidget({super.key, required this.node, required this.registry});
    ...
    return ListView.separated(
      ...
      separatorBuilder: (_, __) {
        ...
        if (sep is Map<String, dynamic>) {
          return registry.build(context, RexaNode.fromJson(sep));
        }
...
class RexaListTileWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaListTileWidget({super.key, required this.node, required this.registry});
...
class RexaScrollViewWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaScrollViewWidget({super.key, required this.node, required this.registry});
...
class RexaSafeAreaWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaSafeAreaWidget({super.key, required this.node, required this.registry});
...
class RexaStackWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaStackWidget({super.key, required this.node, required this.registry});
...
class RexaFlexibleWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaFlexibleWidget({super.key, required this.node, required this.registry});
...
class RexaWrapWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaWrapWidget({super.key, required this.node, required this.registry});
...
class RexaGestureDetectorWidget extends StatelessWidget {
  final RexaNode node;
  final WidgetRegistry registry;
  const RexaGestureDetectorWidget({super.key, required this.node, required this.registry});
...
class RexaUnknownWidget extends StatelessWidget {
  final String type;
  const RexaUnknownWidget({super.key, required this.type});
